...
<title>系统异常</title>
	<style type="text/css">
		...
		.e-4-wrap {background: #3b3b3b url(/static/images/err-404.jpg) no-repeat 0 0;margin: 5% auto 0;width: 640px;overflow: hidden;}
...
<!-- 主体 开始-->
	<div class="e-4-wrap">
            <div class="fl-1">
                <div class="e-4-title"><span>ERROR</span></div>
            </div>
		<div class="fl-2">
